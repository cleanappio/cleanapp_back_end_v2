...
echo "Building report-auth-service docker image..."
...
DOCKER_IMAGE="cleanapp-docker-repo/cleanapp-report-auth-service-image"
...
echo "Report-auth-service docker image build completed successfully!"
