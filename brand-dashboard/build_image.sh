...
echo "Building brand-dashboard docker image..."
...
DOCKER_IMAGE="cleanapp-docker-repo/cleanapp-brand-dashboard-image"
...
echo "brand-dashboard docker image build completed successfully!"
