...
mod tests {
    ...
    fn test_normalize_tag_basic() {
        assert_eq!(
            normalize_tag("Beach").unwrap(),
            ("beach".to_string(), "Beach".to_string())
        );
        assert_eq!(
            normalize_tag("CLEANUP").unwrap(),
            ("cleanup".to_string(), "CLEANUP".to_string())
        );
        assert_eq!(
            normalize_tag("plastic waste").unwrap(),
            ("plastic waste".to_string(), "plastic waste".to_string())
        );
    }
    ...
    fn test_normalize_tag_unicode() {
        assert_eq!(
            normalize_tag("café").unwrap(),
            ("cafe".to_string(), "café".to_string())
        );
        assert_eq!(
            normalize_tag("naïve").unwrap(),
    ...
    fn test_normalize_tag_special_chars() {
        assert_eq!(
            normalize_tag("beach-cleanup").unwrap(),
            ("beach-cleanup".to_string(), "beach-cleanup".to_string())
        );
        assert_eq!(
            normalize_tag("beach.cleanup").unwrap(),
            ("beach.cleanup".to_string(), "beach.cleanup".to_string())
        ...
        assert_eq!(
            normalize_tag("beach_cleanup").unwrap(),
            ("beach_cleanup".to_string(), "beach_cleanup".to_string())
        );
    }
}
