...
func Load() (*Config, error) {
	...
	if err != nil || throttleDays <= 0 { throttleDays = 7 }
	...
	if err != nil || maxDaily <= 0 { maxDaily = 10 }
	...
	if err != nil || maxRetries < 0 { maxRetries = 3 }
	...
	if err != nil || retryMinutes <= 0 { retryMinutes = 30 }
	...
	if err != nil || maxBackoffHours <= 0 { maxBackoffHours = 168 }
	...
	if err != nil || maxRetriesNoValid <= 0 { maxRetriesNoValid = 10 }
...
func (c *Config) GetPollInterval() time.Duration {
	...
	if err != nil { return 30 * time.Second }
	return duration
}
...
func (c *Config) GetBrandlessPhysicalPollInterval() time.Duration {
	...
	if err != nil || duration <= 0 { return 1 * time.Minute }
	return duration
}
