...
echo "Building report-processor docker image..."
...
DOCKER_IMAGE="cleanapp-docker-repo/cleanapp-report-processor-image"
...
echo "Report-processor docker image build completed successfully!"
