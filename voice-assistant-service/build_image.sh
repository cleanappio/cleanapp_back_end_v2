...
echo "Building voice-assistant-service docker image..."
...
DOCKER_IMAGE="cleanapp-docker-repo/cleanapp-voice-assistant-service-image"
...
echo "Voice-assistant-service docker image build completed successfully!"
