...
echo "Building face-detector docker image..."
...
DOCKER_IMAGE="cleanapp-docker-repo/cleanapp-face-detector-image"
...
echo "Face-detector docker image build completed successfully!"
