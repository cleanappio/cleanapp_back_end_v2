...
echo "Building report-analysis-backfill docker image..."
...
DOCKER_IMAGE="cleanapp-docker-repo/cleanapp-report-analysis-backfill-image"
...
echo "Report-analysis-backfill docker image build completed successfully!" 
