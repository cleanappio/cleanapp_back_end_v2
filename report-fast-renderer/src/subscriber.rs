...
use cleanapp_rustlib::rabbitmq::subscriber::{Callback, Subscriber, SubscriberError};
...
impl FastRendererSubscriber {
    pub async fn new() -> Result<Self, SubscriberError> {
        ...
        info!(
            "Initializing FastRendererSubscriber with exchange: {}, queue: {}",
    ...
    pub async fn start_listening(
        ...
        let config = get_config();
        let mut routing_key_callbacks: HashMap<String, Arc<dyn Callback + Send + Sync + 'static>> =
            HashMap::new();
