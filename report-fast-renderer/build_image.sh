...
echo "Building report-fast-renderer docker image..."
...
DOCKER_IMAGE="cleanapp-docker-repo/cleanapp-report-fast-renderer-image"
...
echo "Report-fast-renderer docker image build completed successfully!"
