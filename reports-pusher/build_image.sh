...
echo "Building reports-pusher docker image..."
...
DOCKER_IMAGE="cleanapp-docker-repo/cleanapp-reports-pusher-image"
...
echo "reports-pusher docker image build completed successfully!"
